 ...
 */
@Service
public class OpsLoginServiceImpl implements OpsLoginService {

    public static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60;

    @Value("${ops.jwt.validity:18000}")
    ...
    public ResponseDTO register(UserDTO userDTO) {
        ...
        return registerInternal(userDTO, userService, messageSource, userMapper, UserType.MANAGER);
    }
}
